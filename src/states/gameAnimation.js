    ...
    Alistuff.ext(core.GameAnimationState, core.State, {
        ...
        update: function (deltaTime) {
            ...
            if (this.clip === core.GameAnimationState.CLIP_1) {
                if (nowTime > 228) this.game.setState(new core.GameLevel1State());
            }
            else if (this.clip === core.GameAnimationState.CLIP_2) {
                if (nowTime >= 112) this.game.setState(new core.GameLevel2State());
            }
            else if (this.clip === core.GameAnimationState.CLIP_3) {
                if (nowTime > 14) this.game.setState(new core.GameEndState());
            }
        },
        ...
        setAnimationClip: function (clip) {
            if (clip === core.GameAnimationState.CLIP_1) this.playClip1();
            if (clip === core.GameAnimationState.CLIP_2) this.playClip2();
            if (clip === core.GameAnimationState.CLIP_3) this.playClip3();
        },
